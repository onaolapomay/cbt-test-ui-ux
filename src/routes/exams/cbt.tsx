...
function CBTExamPage() {
  ...
  return (
    <div className="flex flex-col w-full h-dvh bg-zinc-900 text-zinc-100 overflow-hidden relative">
          ...
          {currentQuestion.options.map((opt, idx) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left p-3.5 rounded-xl border text-xs sm:text-sm leading-relaxed transition flex items-start gap-3.5 ${
                  isSelected
      ...
      <footer className="p-3.5 border-t border-zinc-800 bg-zinc-900 flex items-center justify-between gap-2.5 shrink-0 mt-auto shadow-lg w-full">
        <button
